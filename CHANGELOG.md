...
BGUMCL follows [Semantic Versioning 2.0.0](http://semver.org/).
...
- Workflow:
   - Add a workflow to automatically upload releases to Winget. BGUMCL can now be conveniently installed via Winget on Windows. #1639 @pangbo13
...
- Workflow:
   - Add a workflow to automatically upload releases to Snapcraft. BGUMCL can now be installed via Snapcraft (experimental). #1610 @pangbo13
   - Adjust the order of release workflows and update validation field types in the AUR workflow. #1612 @pangbo13
   - Add a workflow to automatically upload releases to Homebrew. BGUMCL can now be conveniently installed via Homebrew on macOS. #1620 @pangbo13

## 1.0.0

`2026-05-05`

**Introducing the first stable release of BGUMCL. 🚀**
...
- 🐛 Fix the issue where Mojang Java runtime downloaded by BGUMCL on macOS lacked execution permissions. #1154 @UNIkeEN  
