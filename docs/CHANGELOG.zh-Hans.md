...
BGUMCL 遵循 [语义化版本规范 2.0.0](https://semver.org/lang/zh-CN/)。
...
- 工作流：
   - 新增发版时自动上传 Snapcraft 的工作流，现在可以通过 Snapcraft 安装 BGUMCL（实验性功能）。#1610 @pangbo13
   - 调整发版工作流顺序、修改 AUR 工作流的校验字段类型。#1612 @pangbo13
   - 新增发版时自动上传 Homebrew 的工作流，现在可以通过 Homebrew 便捷安装 BGUMCL（macOS 平台）。#1620 @pangbo13
