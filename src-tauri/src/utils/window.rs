...
pub fn get_webview_window_config(app: &AppHandle, label: &str) -> BGUMCLResult<WindowConfig> {
  let window_config = app
    ...
    .ok_or_else(|| BGUMCLError(format!("Config label '{}' not found", label)))?;
