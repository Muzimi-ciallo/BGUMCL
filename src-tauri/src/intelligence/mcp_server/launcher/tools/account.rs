  ...
  vec![
    ...
    mcp_tool!(
      ...
      #[serde(deny_unknown_fields)]
      {
        ...
        let value =
          serde_json::to_string(&id).map_err(|e| sjmcl_types::error::BGUMCLError(e.to_string()))?;
    ...
    mcp_tool!(
      ...
      "Retrieve account information from another launcher and import it directly into BGUMCL. Supported launcher_type values: `HMCL`, `MultiMC`.",
      |app, params|
      #[serde(deny_unknown_fields)]
      {
