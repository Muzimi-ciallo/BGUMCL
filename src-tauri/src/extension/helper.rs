...
pub fn get_extensions_dir(app: &AppHandle) -> BGUMCLResult<PathBuf> {
  Ok(
    app
      .path()
...
pub fn read_extension_metadata(extension_dir: &Path) -> BGUMCLResult<ExtensionMetadata> {
...
pub fn read_extension_info(extension_dir: &Path) -> BGUMCLResult<ExtensionInfo> {
...
pub fn resolve_extension_root(extracted_dir: &Path) -> BGUMCLResult<PathBuf> {
...
pub fn extract_extension_package(package_path: &Path, target_dir: &Path) -> BGUMCLResult<()> {
