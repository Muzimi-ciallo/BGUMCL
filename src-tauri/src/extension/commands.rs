...
#[tauri::command]
pub fn retrieve_extension_list(app: AppHandle) -> BGUMCLResult<Vec<ExtensionInfo>> {
...
pub fn add_extension(
  ...
  let register_result = (|| -> BGUMCLResult<ExtensionInfo> {
...
#[tauri::command]
pub fn delete_extension(app: AppHandle, identifier: String) -> BGUMCLResult<()> {
  ExtensionMetadata::validate_identifier(&identifier)?;
