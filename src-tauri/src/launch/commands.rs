...
#[tauri::command]
pub async fn open_game_log_window(app: AppHandle, launching_id: u64) -> BGUMCLResult<()> {
...
#[tauri::command]
pub fn retrieve_game_log(app: AppHandle, launching_id: u64) -> BGUMCLResult<Vec<String>> {
