...
pub fn kill_process(pid: u32) -> BGUMCLResult<()> {
...
pub fn set_process_priority(pid: u32, priority: &ProcessPriority) -> BGUMCLResult<()> {
...
pub fn change_process_window_title(pid: u32, new_title: &str) -> BGUMCLResult<()> {
