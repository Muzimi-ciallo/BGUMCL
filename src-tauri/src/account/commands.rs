...
#[tauri::command]
pub fn retrieve_player_list(app: AppHandle) -> BGUMCLResult<Vec<Player>> {
...
) -> BGUMCLResult<DeviceAuthResponseInfo> {
...
#[tauri::command]
pub fn cancel_oauth(app: AppHandle) -> BGUMCLResult<()> {
  let account_binding = app.state::<Mutex<AccountInfo>>();
  let mut account_state = account_binding.lock()?;
...
#[tauri::command]
pub async fn add_player_from_selection(app: AppHandle, player: Player) -> BGUMCLResult<()> {
...
#[tauri::command]
pub async fn delete_player(app: AppHandle, player_id: String) -> BGUMCLResult<()> {
  {
    let account_binding = app.state::<Mutex<AccountInfo>>();
    let mut account_state = account_binding.lock()?;
...
#[tauri::command]
pub async fn refresh_player(app: AppHandle, player_id: String) -> BGUMCLResult<()> {
...
) -> BGUMCLResult<MicrosoftFriendList> {
...
#[tauri::command]
pub fn retrieve_auth_server_list(app: AppHandle) -> BGUMCLResult<Vec<AuthServer>> {
...
#[tauri::command]
pub async fn fetch_auth_server(app: AppHandle, url: String) -> BGUMCLResult<AuthServer> {
...
#[tauri::command]
pub async fn add_auth_server(app: AppHandle, auth_url: String) -> BGUMCLResult<()> {
  if get_auth_server_info_by_url(&app, auth_url.clone()).is_ok() {
    return Err(AccountError::Duplicate.into());
  }
...
#[tauri::command]
pub fn delete_auth_server(app: AppHandle, url: String) -> BGUMCLResult<()> {
  let account_binding = app.state::<Mutex<AccountInfo>>();
  let mut account_state = account_binding.lock()?;
...
) -> BGUMCLResult<(Vec<Player>, Vec<AuthServer>)> {
