...
#[tauri::command]
pub async fn fetch_game_version_list(app: AppHandle) -> BGUMCLResult<Vec<GameClientResourceInfo>> {
  let priority_list = {
...
pub async fn fetch_game_version_specific(
  app: AppHandle,
  game_version: String,
) -> BGUMCLResult<GameClientResourceInfo> {
...
) -> BGUMCLResult<OtherResourceSearchRes> {
...
) -> BGUMCLResult<Vec<OtherResourceVersionPack>> {
  match download_source {
    OtherResourceSource::CurseForge => {
...
pub async fn fetch_remote_resource_by_local(
  ...
  download_source: OtherResourceSource,
  file_path: String,
) -> BGUMCLResult<OtherResourceFileInfo> {
  match download_source {
    OtherResourceSource::CurseForge => {
...
pub async fn fetch_remote_resource_by_id(
  ...
  download_source: OtherResourceSource,
  resource_id: String,
) -> BGUMCLResult<OtherResourceInfo> {
  match download_source {
    OtherResourceSource::CurseForge => {
