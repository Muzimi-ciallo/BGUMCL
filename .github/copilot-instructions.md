# BGUMCL Copilot Instructions

*This instructions is generated by Copilot agent itself*

## Repository Overview

BGUMCL is a cross-platform Minecraft launcher built with **Tauri v2** architecture. It combines a **Rust backend** with a **Next.js frontend** to provide a native desktop application that supports Windows, macOS, and Linux.
...
- `BGUMCL_CURSEFORGE_API_KEY`: CurseForge API key for mod downloads
